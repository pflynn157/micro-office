/****************************************************************************
** Meta object code from reading C++ file 'searchbar.hpp'
**
...
#include <memory>
#include "../../../../../file-explorer/src/searchbar.hpp"
#include <QtGui/qtextcursor.h>
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'searchbar.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(10, 14), // "onEnterPressed"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 14) // "onCloseClicked"

    },
    "SearchBar\0onEnterPressed\0\0onCloseClicked"
};
...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onEnterPressed(); break;
