/****************************************************************************
** Meta object code from reading C++ file 'multi_contextmenu.hpp'
**
...
#include <memory>
#include "../../../../../file-explorer/src/menu/multi_contextmenu.hpp"
#include <QtGui/qtextcursor.h>
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'multi_contextmenu.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(45, 14), // "onTrashClicked"
QT_MOC_LITERAL(60, 16), // "onRestoreClicked"
QT_MOC_LITERAL(77, 18) // "onDeleteAllClicked"

    },
    "MultiContextMenu\0onCutClicked\0\0"
    "onCopyClicked\0onTrashClicked\0"
    "onRestoreClicked\0onDeleteAllClicked"
};
...
void MultiContextMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onTrashClicked(); break;
        case 3: _t->onRestoreClicked(); break;
        case 4: _t->onDeleteAllClicked(); break;
        default: ;
        }
    }
    (void)_a;
