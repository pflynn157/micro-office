/****************************************************************************
** Meta object code from reading C++ file 'background_contextmenu.hpp'
**
...
#include <memory>
#include "../../../../../file-explorer/src/menu/background_contextmenu.hpp"
#include <QtGui/qtextcursor.h>
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'background_contextmenu.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(22, 18), // "onNewFolderClicked"
QT_MOC_LITERAL(41, 0), // ""
QT_MOC_LITERAL(42, 16), // "onNewFileClicked"
QT_MOC_LITERAL(59, 14) // "onPasteClicked"

    },
    "BackgroundContextMenu\0onNewFolderClicked\0"
    "\0onNewFileClicked\0onPasteClicked"
};
...
void BackgroundContextMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onNewFolderClicked(); break;
        case 1: _t->onNewFileClicked(); break;
        case 2: _t->onPasteClicked(); break;
        default: ;
        }
    }
    (void)_a;
